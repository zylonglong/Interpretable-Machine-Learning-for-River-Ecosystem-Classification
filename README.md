 Interpretable Machine Learning for River Ecosystem Classification
This repository contains model training code and SHAP-based interpretability results for three ecological classification tasks using CatBoost & Randomforest:
